...
namespace kms_slam {
    ...
    // Ref: Visual-Inertial Monocular SLAM with Map Reuse
    ...
    // Ref: On-Manifold Preintegration for Real-Time Visual--Inertial Odometry
    // Forster C, Carlone L, Dellaert F, et al.

    class KMS_IMUPreintegrator{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW

        //Default constructor
        KMS_IMUPreintegrator();

        //Constructor
        KMS_IMUPreintegrator(const KMS_IMUPreintegrator &preintegrator);
