        ...
        for (size_t i = 0; i < vpMP.size(); i++) {
            ...
            for (map<KeyFrame *, size_t>::const_iterator mit = observations.begin(); mit != observations.end(); mit++) {
                ...
                if (pKF->mvuRight[mit->second] < 0) {
                    ...
                    g2o::EdgeStereoNavStatePVRPointXYZ *e = new g2o::EdgeStereoNavStatePVRPointXYZ();// This is different from monocular
...
//        //g2o::OptimizationAlgorithmGaussNewton* solver = new g2o::OptimizationAlgorithmGaussNewton(solver_ptr);
        ...
        g2o::EdgeNavStatePVR *eNSPVR = new g2o::EdgeNavStatePVR();
        {
            ...
            //Here is the chi-square distribution table, the measurement is 9 dimensions, and the confidence level 1-P is 0.01
            const float thHuberNavStatePVR = sqrt(21.666);
            g2o::RobustKernelHuber *rk = new g2o::RobustKernelHuber;
        ...
        g2o::EdgeNavStateBias *eNSBias = new g2o::EdgeNavStateBias();
        {
            ...
            //FIXME The measurement here should be a 6-dimensional 0 vector, but it doesn’t matter if you write this here, because this measurement is not used at all
            ...
            // Here is the chi-square distribution table, the measurement is 6 dimensions, and the confidence level 1-P is 0.01
            const float thHuberNavStateBias = sqrt(16.812);
            g2o::RobustKernelHuber *rk = new g2o::RobustKernelHuber;
            ...
            for (int i = 0; i < Ncur; i++) {
                ...
                if (pMP) {
                    ...
                    } else  // Stereo observation
                    {
                        ...
                        e->SetParams(pFrame->fx, pFrame->fy, pFrame->cx, pFrame->cy, pFrame->mbf, Rbc, Pbc,
                                     Converter::toVector3d(pMP->GetWorldPos()));
            ...
            for (int i = 0; i < Nlast; i++) {
                ...
                if (pMP) {
                    ...
                    } else  // Stereo observation
                    {
                        ...
                        e->SetParams(pLastFrame->fx, pLastFrame->fy, pLastFrame->cx, pLastFrame->cy, pLastFrame->mbf,
        ...
        for (size_t it = 0; it < 4; it++) {
            ...
            for (size_t i = 0, iend = vpEdgesMono.size(); i < iend; i++) {
                ...
                if (pFrame->mvbOutlier[idx]) {
                    e->computeError();// NOTEg2o will recalculate the error of the outlier edge, if the error is less than a certain value, it can become an inlier
                }
            ...
            for (map<KeyFrame *, size_t>::const_iterator mit = observations.begin(), mend = observations.end();
                ...
                if (!pKFi->isBad()) {
                    ...
                    if (pKFi->mvuRight[mit->second] < 0) {
                        ...
                        g2o::EdgeStereoNavStatePVRPointXYZ *e = new g2o::EdgeStereoNavStatePVRPointXYZ();
