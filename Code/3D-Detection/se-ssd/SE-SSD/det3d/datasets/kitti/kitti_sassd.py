...
class KittiDataset(PointCloudDataset):
    ...
    def __init__(self, root_path, info_path, cfg=None, pipeline=None, class_names=None, test_mode=False, **kwargs):
        ...
        augmentor_cfg = dict(
            type='PointAugmentor',
            root_path="/home/lacie/Dataset/Kitti/training",
            info_path="/home/lacie/Dataset/Kitti/kitti_dbinfos_train.pkl",   # x, y, z, l, h, w, ry.  bottom_center_z
            sample_classes=['Car'],
            min_num_points=5,
            sample_max_num=15,
...
if __name__ == "__main__":
    ...
    data_path = "/home/lacie/Dataset/Kitti/"
    info_path = "/home/lacie/Dataset/Kitti/kitti_infos_train.pkl"
