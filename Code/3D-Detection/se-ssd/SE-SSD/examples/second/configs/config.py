...
data_root_prefix = "/home/lacie/Dataset/Kitti/"
...
db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path=data_root_prefix + "/dbinfos_" + my_paras['data_mode'] +".pkl",
...
log_level = "INFO"
work_dir = "/home/lacie/Dataset/Kitti/saved_model/" + TAG
...
load_from = "/home/lacie/Dataset/Kitti/saved_model/cia-ssd-model.pth"
resume_from = None
